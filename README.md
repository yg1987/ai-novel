...
- [ ] 上下文引擎完整版 — DataSourceRegistry 架构 + 角色认知 + 伏笔 + 文风注入 prompt
- [ ] 关键词 + 向量混合搜索 — CJK 分词 + RRF 融合 + LanceDB 向量库
- [ ] 写作统计看板 — JSONL 事件日志 + 日更/趋势/伏笔债评分
