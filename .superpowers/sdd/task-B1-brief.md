...
Add to the `invoke_handler!` macro call (around line 438):
```rust
search_project_files,
```

- [ ] **Step 4: Add API bindings to src/api/tauri.ts**

Add at bottom of `src/api/tauri.ts`:
```typescript
...
- [ ] **Step 5: Verify Rust + TypeScript compile**
